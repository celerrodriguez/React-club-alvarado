          ...
          <div className='col-md-8'>
            <div className='card-body'>
                ...
                <div>
                  ...
                  /> :
                  <Link to='/cart' className='btn btn-secondary mt-3'> Ir al carrito</Link>
                  }
                  <Link className='pt-2 mt-2' to='/' style={{color: "#04042f", textDecorationLine:"underline"}}><strong>⇽ Volver</strong> </Link>
